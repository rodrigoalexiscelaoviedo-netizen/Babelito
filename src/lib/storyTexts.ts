/**
 * Banco de historias preloaded para seed.
 * Estas NO se insertan por código — ver seed_stories.sql en la raíz del repo.
 * Este archivo sirve como referencia tipada del contenido.
 */
...
He knew that this kind of opportunity rarely came twice. That Sunday morning, he sat in his small flat, staring at the business card. Perhaps it was time to consider whether music could become more than just a weekend hobby. The idea both excited and frightened him enormously.`,
    questions: [
      {
        question: "What does Tom do during the week?",
        options: ["He works as a musician", "He works as an accountant", "He works at a club", "He studies at university"],
        correct_index: 1,
      },
      {
        question: "When does Tom usually prepare his playlist?",
        options: ["On Saturday afternoons", "On Friday mornings", "On Thursday evenings", "On Sunday nights"],
        correct_index: 2,
      },
      {
        question: "What unexpected event happened last weekend?",
        options: ["A friend joined him behind the decks", "The sound system broke down", "A record label manager approached him", "The club owner offered him a contract"],
        correct_index: 2,
      },
      {
        question: "How did Tom feel after the record label manager spoke to him?",
        options: ["Angry and defensive", "So surprised he could barely speak", "Immediately confident", "Disappointed by the offer"],
        correct_index: 1,
      },
    ],
  },
  {
    ...
    level: "B1",
    topic: "investments",
    content: `Sarah had always been careful with her money, but she had never invested any of it. She kept her savings in a standard bank account, earning almost no interest. One afternoon, a colleague mentioned that she had started investing in index funds, and Sarah became curious.
...
Three months later, she checked her account and noticed that her investment had grown slightly. It was not a dramatic sum, but it was more than her savings account would have produced. More importantly, she felt that she was finally making her money work for her, rather than letting it sit idle.`,
    questions: [
      {
        question: "Why did Sarah become interested in investing?",
        options: ["She read a book about finance", "A colleague mentioned index funds", "Her bank manager advised her", "She saw an advertisement"],
        correct_index: 1,
      },
      {
        question: "What is an index fund?",
        options: ["A savings account with high interest", "A fund that tracks a group of companies", "A type of individual company share", "A government bond"],
        correct_index: 1,
      },
      {
        question: "How much did Sarah decide to invest each month?",
        options: ["Fifty pounds", "Two hundred pounds", "One hundred pounds", "Five hundred pounds"],
        correct_index: 2,
      },
      {
        question: "What did Sarah notice three months later?",
        options: ["Her investment had lost money", "Her investment had grown slightly", "Her account had been closed", "She had become wealthy"],
        correct_index: 1,
      },
    ],
  },
  {
    ...
    content: `James started working from home last year. At first, he was very happy. He did not have to travel to the office every morning. He could wake up later and have breakfast at home. He saved a lot of time and money on transport.
...
Now, six months later, James enjoys working from home. He has a good routine and he feels healthy and happy. He still misses some things about the office, like the free coffee and the birthday cakes, but overall he thinks working from home is a great way to work.`,
    questions: [
      {
        question: "Why was James happy at first?",
        options: ["He got a pay rise", "He did not have to travel to work", "He had a new laptop", "His colleagues visited him"],
        correct_index: 1,
      },
      {
        question: "What was James's main problem after a few weeks?",
        options: ["His internet connection was slow", "He felt lonely and could not stop working", "His flat was too small", "He did not like his manager"],
        correct_index: 1,
      },
      {
        question: "What did James do to improve his situation?",
        options: ["He returned to the office", "He moved his desk and set a finish time", "He changed his job", "He bought a new flat"],
        correct_index: 1,
      },
      {
        question: "What does James still miss about the office?",
        options: ["His manager", "The noise and activity", "Free coffee and birthday cakes", "His old desk"],
        correct_index: 2,
      },
    ],
  },
  {
    ...
    level: "A2",
    topic: "travel",
    content: `Last summer, Maria visited Edinburgh for the first time. She travelled by train from London. The journey took about four and a half hours. Maria read a book and listened to music on the way. She arrived at Edinburgh Waverley station in the afternoon.
...
On her last day, she visited the Scottish National Museum. The museum was free and had interesting things about Scottish culture, science, and history. Maria was very tired at the end of her trip, but she was also very happy. She decided that she would definitely come back to Scotland one day.`,
    questions: [
      {
        question: "How did Maria travel to Edinburgh?",
        options: ["By plane", "By car", "By train", "By bus"],
        correct_index: 2,
      },
      {
        question: "Where did Maria go on the first morning?",
        options: ["The Royal Mile", "Edinburgh Castle", "The Scottish National Museum", "A restaurant"],
        correct_index: 1,
      },
      {
        question: "What did Maria buy for her family?",
        options: ["A postcard", "Scottish shortbread", "A Scottish flag", "A bottle of whisky"],
        correct_index: 1,
      },
      {
        question: "How much did the Scottish National Museum cost?",
        options: ["Ten pounds", "Twenty pounds", "Five pounds", "Nothing — it was free"],
        correct_index: 3,
      },
    ],
  },
...
The debate is far from settled. As artificial intelligence begins to generate music autonomously, questions about authorship, royalties, and the very definition of artistic creativity are becoming increasingly urgent.`,
    questions: [
      {
        question: "What is the main argument of critics regarding streaming?",
        options: ["Streaming is too complicated for older artists", "Royalties are too low to generate meaningful income", "Streaming platforms have poor sound quality", "Physical formats are still more popular"],
        correct_index: 1,
      },
      {
        question: "What advantage of streaming do its supporters highlight?",
        options: ["It pays artists very well", "It makes music more expensive for listeners", "It allows any artist to reach a global audience", "It reduces the need for live performances"],
        correct_index: 2,
      },
      {
        question: "How have artists compensated for lower recording revenue?",
        options: ["By raising the price of albums", "By focusing on touring and merchandise", "By signing with major labels exclusively", "By leaving the music industry"],
        correct_index: 1,
      },
      {
        question: "What new challenge is mentioned at the end of the text?",
        options: ["The decline of live music", "The return of vinyl records", "AI generating music autonomously", "Streaming platforms going bankrupt"],
        correct_index: 2,
      },
    ],
  },
  {
    title: "Passive Income and Financial Freedom",
    level: "B2",
    topic: "investments",
    content: `The concept of passive income has captured the imagination of a generation raised on the promise of financial independence. The idea is straightforward: build assets that generate money with minimal ongoing effort, eventually reaching a point where investment returns cover living expenses — a state commonly referred to as financial freedom or, in investment circles, FIRE (Financial Independence, Retire Early).
...
What financial advisers consistently emphasise is that no passive income strategy eliminates risk entirely. Markets fall, tenants default, and businesses encounter difficulties. The goal is not to eliminate uncertainty but to manage it intelligently, building a diversified portfolio resilient enough to weather inevitable storms whilst growing steadily over the long term.`,
    questions: [
      {
        question: "What does FIRE stand for in the context of this text?",
        options: ["Fixed Income Regular Earnings", "Financial Independence, Retire Early", "Funds, Investments, Returns, Equity", "Free Income, Reliable Earnings"],
        correct_index: 1,
      },
      {
        question: "What does compound growth mean?",
        options: ["Investing in many different countries", "Saving money in a bank account", "Returns generating further returns over time", "Buying and selling shares quickly"],
        correct_index: 2,
      },
      {
        question: "What is one disadvantage of property investment mentioned in the text?",
        options: ["It never produces rental income", "It requires no initial capital", "It involves maintenance costs and vacancies", "Dividends are never guaranteed"],
        correct_index: 2,
      },
      {
        question: "What do financial advisers emphasise about passive income strategies?",
        options: ["They always guarantee profit", "No strategy eliminates risk entirely", "Property is always the best option", "Investors should never sell their holdings"],
        correct_index: 1,
      },
    ],
  },
  {
    ...
    content: `Emma had been working as a graphic designer for the same company for three years. She enjoyed her job, but the daily commute to the office was exhausting. When her company announced that employees could work remotely full time, she saw an opportunity she had always dreamed about.
...
After six months in Lisbon, Emma moved to Barcelona. She was no longer nervous about setting up her life in a new place. She had learnt to pack efficiently, to research neighbourhoods before arriving, and most importantly, to enjoy the remarkable privilege of working from some of the world's most beautiful cities.`,
    questions: [
      {
        question: "Why did Emma see an opportunity when her company allowed remote work?",
        options: ["She wanted to earn more money", "She had always dreamed of travelling while working", "She needed to visit a family member abroad", "She disliked her job"],
        correct_index: 1,
      },
      {
        question: "Where did Emma go first?",
        options: ["Bangkok", "Mexico City", "Barcelona", "Lisbon"],
        correct_index: 3,
      },
      {
        question: "What did Emma carry as a backup for internet access?",
        options: ["A laptop with extra storage", "A portable wi-fi device", "A second mobile phone", "A list of local cafés"],
        correct_index: 1,
      },
      {
        question: "What important lesson did Emma learn about being a nomad?",
        options: ["She should always stay in the same place", "She needed to separate working hours from exploring hours", "Remote work is too difficult to manage", "She should return to the office"],
        correct_index: 1,
      },
    ],
  },
  {
    ...
    level: "A2",
    topic: "general / lifestyle",
    content: `When David moved into his own flat for the first time, he did not know how to cook anything. He only knew how to make toast and pour cereal. Every evening, he ordered takeaway food or went to a cheap restaurant near his home. After one month, he realised that this was very expensive and also unhealthy.
...
After three months, David could make ten different dishes. His friends were impressed when he invited them to dinner. He spent much less money on food and felt healthier. He also discovered that he really enjoyed cooking. It was creative and relaxing after a long day at work.`,
    questions: [
      {
        question: "Why did David decide to learn to cook?",
        options: ["His friends asked him to", "Eating out was too expensive and unhealthy", "He wanted a new hobby", "His doctor told him to"],
        correct_index: 1,
      },
      {
        question: "What was the first recipe David tried?",
        options: ["Chicken with vegetables", "Pasta with tomato sauce", "A birthday cake", "Rice and beans"],
        correct_index: 1,
      },
      {
        question: "What happened the first time David cooked chicken?",
        options: ["It was perfect", "It was too salty", "He burnt it", "It was undercooked"],
        correct_index: 2,
      },
      {
        question: "How did David feel about cooking after three months?",
        options: ["He found it boring", "He gave up and ordered takeaway again", "He really enjoyed it", "He was still not very good"],
        correct_index: 2,
      },
    ],
  },
  {
    ...
    content: `When Laura's therapist suggested that she take a month-long break from social media, Laura's initial reaction was something close to panic. She was a content creator with nearly eighty thousand followers across three platforms, and the idea of disappearing from her feeds felt professionally reckless, if not personally terrifying.
...
When the month concluded and she reinstalled the apps, she felt no particular urgency to scroll. She reduced her posting frequency by half, set strict time limits, and began treating social media as a tool rather than a habitat. Her follower count, she noted with some amusement, had actually increased during her absence.`,
    questions: [
      {
        question: "Why did Laura initially react with panic to the suggestion?",
        options: ["She was addicted to gaming", "She felt it was professionally reckless as a content creator", "She did not trust her therapist", "She had important news to share"],
        correct_index: 1,
      },
      {
        question: "What did Laura notice during the first week of her detox?",
        options: ["She lost all her followers", "She became very productive immediately", "She began noticing details she had previously missed", "She felt completely fine without social media"],
        correct_index: 2,
      },
      {
        question: "How did the detox affect her friendships?",
        options: ["She lost contact with most friends", "Her friendships became more intentional", "She made many new friends online", "She became isolated and unhappy"],
        correct_index: 1,
      },
      {
        question: "What happened to her follower count during her absence?",
        options: ["It fell dramatically", "It stayed exactly the same", "It actually increased", "She never checked"],
        correct_index: 2,
      },
    ],
  },
  {
    title: "Behind the Decks at Glastonbury",
    level: "B1",
    topic: "music / festivals",
    content: `Nina had been DJing at small venues for five years, but nothing had prepared her for the scale of Glastonbury. The festival invited her to play a two-hour set at the Park Stage on Friday evening. When the invitation arrived by email, she read it three times before she believed it was real.
...
Afterwards, backstage, she sat quietly with a cup of tea and tried to process what had just happened. A journalist asked her how it felt to play to such a large crowd. She thought for a moment before answering: it felt, she said, like conducting a conversation where everybody understood the language perfectly.`,
    questions: [
      ...
      {
        question: "What advice did experienced DJs give Nina?",
        options: ["Prepare a very strict set list", "Read the crowd, not the clock", "Always play the most popular songs", "Start slowly and build up gradually"],
        correct_index: 1,
      },
      {
        question: "How did Nina feel once she started playing?",
        options: ["More nervous than before", "The anxiety dissolved and she played instinctively", "She made many technical mistakes", "She regretted coming"],
        correct_index: 1,
      },
      {
        question: "How did Nina describe the experience of playing to a large crowd?",
        options: ["Terrifying and overwhelming", "Like a job interview", "Like conducting a conversation everyone understood", "Like playing alone in her bedroom"],
        correct_index: 2,
      },
    ],
  },
...
After eight months, he had five hundred pounds in his emergency fund. The following year, his washing machine stopped working and he needed to buy a new one. This time, he paid for it himself without any stress. He felt proud and much more secure about his financial situation.`,
    questions: [
      {
        question: "Why did Pedro need to borrow money from his parents?",
        options: ["He wanted to go on holiday", "His car broke down and he had no savings", "He lost his job", "He had to pay university fees"],
        correct_index: 1,
      },
      {
        question: "What is an emergency fund?",
        options: ["A loan from the bank", "Money saved for unexpected problems", "A type of insurance policy", "A government payment"],
        correct_index: 1,
      },
      {
        question: "How did Pedro save sixty pounds a month?",
        options: ["He stopped eating at restaurants", "He got a second job", "He cancelled subscriptions and made coffee at home", "He moved to a cheaper flat"],
        correct_index: 2,
      },
      {
        question: "How did Pedro feel when his washing machine broke down the following year?",
        options: ["Embarrassed and stressed again", "He was able to pay for it himself without stress", "He had to borrow money again", "He could not afford a new one"],
        correct_index: 1,
      },
    ],
  },
  {
    title: "Starting Over in Manchester",
    level: "B1",
    topic: "general / life changes",
    content: `When Clara accepted a job offer in Manchester, she had exactly three weeks to pack up her life in Madrid and move to a city she had visited only once, briefly, during a rainy November. Her Spanish friends thought she was brave. Her mother thought she was mad.
...
Six months after arriving, Clara sat in a café near her flat and wrote her mother a long message. She described the running club, her new colleagues, and a gig she had been to the previous night. She ended the message by saying that she was not sure Manchester was quite home yet, but that she was beginning to feel, at last, that it could be.`,
    questions: [
      {
        question: "Why did Clara move to Manchester?",
        options: ["She had family there", "She accepted a job offer", "She wanted to study", "She was travelling"],
        correct_index: 1,
      },
      {
        question: "What was one thing Clara missed about Madrid?",
        options: ["The museums", "The noise, warmth, and energy of summer evenings", "The food", "The public transport"],
        correct_index: 1,
      },
      {
        question: "How did Clara meet people in Manchester?",
        options: ["Through her workplace only", "By joining a running club in Heaton Park", "Through social media", "At language exchange events"],
        correct_index: 1,
      },
      {
        question: "How did Clara describe Manchester to her mother after six months?",
        options: ["She hated it and wanted to return", "She was not sure it was home yet but felt it could be", "She was completely happy", "She was planning to move again"],
        correct_index: 1,
      },
    ],
  },
